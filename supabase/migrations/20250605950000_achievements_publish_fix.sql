-- achievements publish fix — hosted não tem achievements.updated_at
--
-- Erro: column "updated_at" of relation "achievements" does not exist
-- A RPC de publicação passa a ser defensiva para colunas opcionais em achievements.
