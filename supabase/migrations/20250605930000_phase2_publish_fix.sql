-- Phase 2 fix — publicação de submissões no schema hosted
--
-- Problemas corrigidos:
--   * RPC referenciava games.version (coluna inexistente; versão vive em game_builds)
--   * game_builds.updated_at pode faltar no hosted (schema anterior ao document03)
--   * Colunas bilíngues / flags podem faltar em instâncias antigas
